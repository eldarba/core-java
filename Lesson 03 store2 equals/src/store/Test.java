...
//		System.out.println(store.getBook("book1"));
		System.out.println(store.getBook(new Book("book1")));
		System.out.println(store.getBook(new Book("book100")));

		System.out.println(store.getCd(new CD("cd1")));
		System.out.println(store.getCd(new CD("cd100")));
